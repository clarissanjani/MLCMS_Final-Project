...
def classic_runge_kutta_mu(integration_model, y0, t, mu):
    """
    :param integration_model:
    :param y0:
    :param t:
    ...
    for n in range (0, len(t) - 1):
        ...
        k_1 = integration_model(y, t[n], mu)
        k_2 = integration_model(y + (h/2)*k_1, t[n] + (h/2), mu)
        k_3 = integration_model(y + (h/2)*k_2, t[n] + (h/2), mu)
        k_4 = integration_model(y + h*k_3, t[n] + h, mu)
